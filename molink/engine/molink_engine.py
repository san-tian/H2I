...
class MolinkEngine(AsyncLLMEngine):
    ...
    def culculate_batch_num(self): 
        ...
        for batch_num in range(base_batch_num + 1, self.engine.max_batch_num + 1):
            # Soft cap per-batch workload so scheduler spreads requests evenly.
